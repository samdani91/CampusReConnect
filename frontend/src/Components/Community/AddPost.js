...
const AddPost = ({ setPost, onPostAdded, editingPost,communityId }) => {
    ...
    const handleUpload = async (e) => {
        ...
        try {
            ...
            setMessage({ text: `Post ${editingPost ? "updated" : "uploaded"} successfully!`, type: 'success' });
    ...
    return (
        <div className="mt-4">
            <h4 className="mb-4">{editingPost ? "Edit Post" : "Your Post"}</h4>
            <div className="p-4 bg-light">
                <div className="mb-3">
                    ...
                    >
                        <option value="">Select your post type</option>
